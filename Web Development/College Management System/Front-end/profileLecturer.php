...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="lecturer_index.php">MIT</a>
      ...
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link" id="students-tab" data-toggle="tab"  href="#students" aria-controls="students">Advisory Student</a>
        </li>
        <li class="nav-item">
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="exam" role="tabpanel" aria-labelledby="exam-tab">
            ...
            <tbody>
                ...
                $l_name =  $row['lecturer_name'];   //found the teacher

                $query2 = "SELECT * FROM course WHERE lecturer = '$l_name'";
                $results2 = mysqli_query($db, $query2); //found tuples of lessons
        ...
        <div class="tab-pane fade" id="myprofile" role="tabpanel" aria-labelledby="myprofile-tab">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="https://static-00.iconduck.com/assets.00/teacher-emoji-2048x2044-fzuvftxs.png" alt="Card image cap">
            <div class="card-body">
              <?php
                  ...
                  <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                    <div class="card-body">
                      <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"><?php echo $row['website']; ?></li>
                      </ul>
                    </div>
                  </div>
                </div>
